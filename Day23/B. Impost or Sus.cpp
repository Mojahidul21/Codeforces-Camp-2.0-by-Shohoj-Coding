// Title: B. Impost or Sus
// Problem: https://codeforces.com/contest/2178/problem/B
// Solution: https://codeforces.com/contest/2178/submission/388978711
...
if(s.front()!='s')++ans,s.front()='s';

if(s.back()!='s')++ans,s.back()='s';
