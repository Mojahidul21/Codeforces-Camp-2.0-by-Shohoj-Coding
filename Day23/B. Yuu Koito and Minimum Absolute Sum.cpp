...
// Poblem: https://codeforces.com/contest/2171/problem/B
// Solution: https://codeforces.com/contest/2171/submission/389234562
...
if((-1==l&&r==n)||(0<l&&l==r&&r<n-1)||(0<l&&l<r&&r<n-1))a[0]=a[n-1]=0;
else if((!l&&!r)||(!l&&l<r&&r<n-1))a[n-1]=a[0];
else if((l==n-1&&r==l)||(0<l&&l<r&&r==n-1))a[0]=a[n-1];

cout<<abs(a[0]-a[n-1])<<'\n';
for(const auto&i:a)cout<<(i<0?0:i)<<' ';
