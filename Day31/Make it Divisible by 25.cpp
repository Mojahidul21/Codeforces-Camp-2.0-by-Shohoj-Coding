...
// Solution: https://codeforces.com/contest/1593/submission/381407021
...
string s,fruit{"25507500"};

tcl

cin>>s;

auto cnt=[&](string seed){
    int seed0{-1},seed1{-1};
    ...
    return seed0!=-1?(int)s.size()-seed0-2:imx;
};

int mn{imx};
for(int i{};i<7;i+=2)
    mn=min(mn,cnt(fruit.substr(i,2)));
