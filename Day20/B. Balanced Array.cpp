// Title: B. Balanced Array
// Problem: https://codeforces.com/problemset/problem/1343/B
// Solution: https://codeforces.com/contest/1343/submission/387332692
...
if(n%4){pno}
    ...
    pye
    cout<<'\n';
    for(int i{},j{n/2},k{2};i<j;++i,k+=2)
        cout<<k<<' ';

    int anchor;
    for(int i{},j{n/4},k{1};i<j;++i,anchor=k+=2)
        cout<<k<<' ';

    for(int i{},j{n/4},k{anchor+2};i<j;++i,k+=2)
        cout<<k<<' ';
}
