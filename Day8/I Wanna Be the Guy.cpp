...
// Solution: https://codeforces.com/contest/469/submission/378566746
...
int n,p,q;
cin>>n>>p;
while(p--)cin>>q,s.insert(q);

cin>>q;
while(q--)cin>>p,s.insert(p);

cout<<(s.size()<n?"Oh, my keyboard!":"I become the guy.");
