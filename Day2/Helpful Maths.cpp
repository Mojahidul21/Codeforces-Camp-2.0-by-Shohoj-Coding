...
// Solution: https://codeforces.com/contest/339/submission/374638539
...
for(int i{};i<count(all(a),'1');++i)b+="1+";
for(int i{};i<count(all(a),'2');++i)b+="2+";
for(int i{};i<count(all(a),'3');++i)b+="3+";
