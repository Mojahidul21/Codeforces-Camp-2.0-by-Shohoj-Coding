// Title: A. Restoring Three Numbers
// Problem: https://codeforces.com/problemset/problem/1154/A
// Solution: https://codeforces.com/contest/1154/submission/379290564
...
int x{a},y{b},z{c},mx{max({a,b,c,d})};

if(a==mx){x=b,y=c,z=d;}
else if(b==mx){x=a,y=c,z=d;}
else if(c==mx){x=a,y=b,z=d;}
