...
// Problem: https://codeforces.com/contest/271/problem/A
// Solution: https://codeforces.com/contest/271/submission/375268394
...
++y,sy=to_string(y),s=set<char>(all(sy));

while(s.size()<4)++y,sy=to_string(y),s=set<char>(all(sy));
